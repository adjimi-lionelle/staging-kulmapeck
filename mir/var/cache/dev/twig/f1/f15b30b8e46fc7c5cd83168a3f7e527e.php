...
class __TwigTemplate_ff7d0cc3174288732d6d9fb0b8384a50 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        // line 9
        echo "    <h2 class=\"mb-0 h3\">Reset your password</h2>
    ...
    ";
        ...
        <button class=\"btn btn-primary mt-3\">Send password reset email <i class=\"fas fa-paper-plane\"></i></button>
    ";
        // line 21
...
{% block formBlock %}
    ...
    {% endfor %}
    <h2 class=\"mb-0 h3\">Reset your password</h2>
...
{% endblock %}
", "reset_password/request.html.twig", "V:\\PROJECT\\kulmapeck\\templates\\reset_password\\request.html.twig");
    }
}
