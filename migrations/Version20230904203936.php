 ...
 */
final class Version20230904203936 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evaluation (id INT AUTO_INCREMENT NOT NULL, matiere_id INT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, start_at DATETIME NOT NULL, end_at DATETIME NOT NULL, duree SMALLINT NOT NULL, is_generated_random_questions TINYINT(1) NOT NULL, slug VARCHAR(255) NOT NULL, is_passed TINYINT(1) NOT NULL, INDEX IDX_1323A575F46CD258 (matiere_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE evaluation_resultat (id INT AUTO_INCREMENT NOT NULL, evaluation_id INT NOT NULL, eleve_id INT NOT NULL, contents LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', note_obtenue DOUBLE PRECISION NOT NULL, date_evaluation_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_EA9524C4456C5646 (evaluation_id), INDEX IDX_EA9524C4A6CC7B2 (eleve_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE network_config (id INT AUTO_INCREMENT NOT NULL, nombre_de_points_par_invitaton INT NOT NULL, pourcentage_distribution_enseignant DOUBLE PRECISION NOT NULL, pourcentage_distribution_eleve DOUBLE PRECISION NOT NULL, taux_de_change DOUBLE PRECISION NOT NULL, minimum_retirable DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE retrait (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, payment_method_id INT NOT NULL, montant DOUBLE PRECISION NOT NULL, is_done TINYINT(1) NOT NULL, numero_telephone VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', status VARCHAR(50) DEFAULT NULL, transaction_reference VARCHAR(150) DEFAULT NULL, INDEX IDX_D9846A51A76ED395 (user_id), INDEX IDX_D9846A515AA1164F (payment_method_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
