...
final class Version20250306201704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE chat_message ADD is_read TINYINT(1) NOT NULL');
        ...
        $this->addSql('ALTER TABLE kulmapeck_user CHANGE email email VARCHAR(180) DEFAULT NULL, CHANGE password password VARCHAR(255) NOT NULL, CHANGE username username VARCHAR(180) NOT NULL, CHANGE phone_number phone_number VARCHAR(180) DEFAULT NULL');
