 ...
 */
final class Version20250307094728 extends AbstractMigration
{
...
//	    $this->addSql('ALTER TABLE matiere_cycle ADD CONSTRAINT FK_3C267FE6F46CD258 FOREIGN KEY (matiere_id) REFERENCES categorie (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE subject_chat CHANGE teacher_persona_id teacher_persona_id INT NOT NULL');
