...
/* front/about/become_teacher.html.twig */
class __TwigTemplate_cdef4ec943ce8dd93cda29d920d2eebe extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "front/about/become_teacher.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "front/about/become_teacher.html.twig"));

        $this->parent = $this->loadTemplate("front/base.html.twig", "front/about/become_teacher.html.twig", 1);
    ...
    <section class=\"bg-light py-5 position-relative overflow-hidden\">
        ...
        <div class=\"container position-relative\">
            <div class=\"row g-4 align-items-center\">
                <div class=\"col-md-6\">
                    ...
                    <h1>";
        // line 84
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("APPLYASINSTRUCTOR_KEY", [], "messages");
        echo "</h1>
                    <p>";
        // line 85
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("APPLYASINSTRUCTORDESCRIPTION_KEY", [], "messages");
        echo "</p>
                    <!-- Button -->
                    <a href=\"#contactTitle\" class=\"btn btn-primary mb-0\">";
        // line 87
        ...
        echo "</a>
                ...
                <div class=\"col-md-6 text-center\">
                    ...
                    <img src=\"";
        // line 92
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/element/04.svg"), "html", null, true);
        echo "\" class=\"h-300px h-xl-400px\" alt=\"\">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class=\"container\">
            ...
            <div class=\"row mb-4\">
                <div class=\"col-sm-10 col-xl-6 text-center mx-auto\">
                    <h2>";
        // line 107
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("STARTITLE_KEY", [], "messages");
        echo "</h2>
                    <p class=\"mb-0\">";
        // line 108
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("STARTITLEDESCRIPTION_KEY", [], "messages");
        echo "</p>
                </div>
            </div>
            ...
            <div class=\"row g-4 g-md-5\">
                ...
                <div class=\"col-md-4 text-center\">
                    <img src=\"";
        // line 116
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/element/create-account.svg"), "html", null, true);
        echo "\" class=\"h-200px\" alt=\"\">
                    <h4 class=\"mt-3\">";
        // line 117
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("CREATEACCOUNT_KEY", [], "messages");
        echo "</h4>
                    <p class=\"text-truncate-2 mb-0\">";
        // line 118
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("STARCREATEACCOUNTDESCRIPTION_KEY", [], "messages");
        echo "</p>
                </div>
                ...
                <div class=\"col-md-4 text-center\">
                    <img src=\"";
        // line 123
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/element/add-course.svg"), "html", null, true);
        echo "\" class=\"h-200px\" alt=\"\">
                    <h4 class=\"mt-3\">";
        // line 124
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("STARADDYOURCOURSE_KEY", [], "messages");
        echo "</h4>
                    <p class=\"text-truncate-2 mb-0\">";
        // line 125
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("STARADDYOURCOURSEDESCRIPTION_KEY", [], "messages");
        echo "</p>
                </div>
                ...
                <div class=\"col-md-4 text-center\">
                    <img src=\"";
        // line 130
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/element/earn-money.svg"), "html", null, true);
        echo "\" class=\"h-200px\" alt=\"\">
                    <h4 class=\"mt-3\">";
        // line 131
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("STAREARINGMONEY_KEY", [], "messages");
        echo "</h4>
                    <p class=\"text-truncate-2 mb-0\">";
        // line 132
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("STAREARINGMONEYDESCRIPTITON_KEY", [], "messages");
        echo "</p>
                </div>
            </div> <!-- Row END -->
        </div>
...
\t\t\t\t</svg>
        ...
        // line 166
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("TOTALCOURSES_KEY", [], "messages");
        echo "</h6>
                    </div>
                    ...
                    <div class=\"col-sm-6 col-lg-3 text-center\">
                        ...
                        <h6 class=\"mb-0 fw-bold\">";
        // line 175
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("TOTALINSTRUCTORS_KEY", [], "messages");
        echo "</h6>
                    </div>
        ...
        echo "</h6>
                    ...
                    <div class=\"col-sm-6 col-lg-3 text-center\">
                        ...
                        <h6 class=\"mb-0 fw-bold\">";
        // line 193
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("LANGUAGES_KEY", [], "messages");
        echo "</h6>
                    </div>
                </div> <!-- Row END -->
            </div>
    ...
    <section id=\"contactTitle\">
        ...
        echo "</h3>
                        ...
                        ";
        // line 222
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["contactForm"]) || array_key_exists("contactForm", $context) ? $context["contactForm"] : (function () { throw new RuntimeError('Variable "contactForm" does not exist.', 222, $this->source); })()), 'form_start', ["attr" => ["class" => "row g-3 mt-2 position-relative z-index-9"]]);
        echo "
                            <!-- Name -->
                            <div class=\"col-lg-6\">
                                ";
        // line 225
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["contactForm"]) || array_key_exists("contactForm", $context) ? $context["contactForm"] : (function () { throw new RuntimeError('Variable "contactForm" does not exist.', 225, $this->source); })()), "name", [], "any", false, false, false, 225), 'label');
        echo "
                                ";
        // line 226
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["contactForm"]) || array_key_exists("contactForm", $context) ? $context["contactForm"] : (function () { throw new RuntimeError('Variable "contactForm" does not exist.', 226, $this->source); })()), "name", [], "any", false, false, false, 226), 'widget');
        echo "
                            </div>
                            <!-- Email -->
                            <div class=\"col-lg-6\">
                                ";
        // line 230
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["contactForm"]) || array_key_exists("contactForm", $context) ? $context["contactForm"] : (function () { throw new RuntimeError('Variable "contactForm" does not exist.', 230, $this->source); })()), "email", [], "any", false, false, false, 230), 'label');
        echo "
                                ";
        // line 231
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["contactForm"]) || array_key_exists("contactForm", $context) ? $context["contactForm"] : (function () { throw new RuntimeError('Variable "contactForm" does not exist.', 231, $this->source); })()), "email", [], "any", false, false, false, 231), 'widget');
        echo "
                            </div>
                            <!-- Textarea -->
                            <div class=\"col-12\">
                                ";
        // line 235
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["contactForm"]) || array_key_exists("contactForm", $context) ? $context["contactForm"] : (function () { throw new RuntimeError('Variable "contactForm" does not exist.', 235, $this->source); })()), "message", [], "any", false, false, false, 235), 'label');
        echo "
                                ";
        // line 236
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["contactForm"]) || array_key_exists("contactForm", $context) ? $context["contactForm"] : (function () { throw new RuntimeError('Variable "contactForm" does not exist.', 236, $this->source); })()), "message", [], "any", false, false, false, 236), 'widget', ["attr" => ["rows" => "3", "spellcheck" => false]]);
        echo "
                            </div>
                            <!-- Button -->
                            <div class=\"col-12\">
                        ...
                        ";
        // line 242
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["contactForm"]) || array_key_exists("contactForm", $context) ? $context["contactForm"] : (function () { throw new RuntimeError('Variable "contactForm" does not exist.', 242, $this->source); })()), 'form_end');
        echo "
                        <!-- Form END -->
                    </div>
                </div>
                ...
                <div class=\"col-lg-7 z-index-9 mt-5 mt-xl-0\">
                    <h3>";
        // line 250
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("HOWTOBECOMEANINSTRUCTOR_KEY", [], "messages");
        echo "</h3>
                    <ul class=\"nav nav-pills nav-pill-soft my-4\" id=\"course-pills-tab\" role=\"tablist\">
                        ...
                        <li class=\"nav-item me-2 me-lg-4\" role=\"presentation\">
                            <button class=\"nav-link mb-2 mb-xl-0 active\" id=\"course-pills-tab-1\" data-bs-toggle=\"pill\" data-bs-target=\"#course-pills-1\" type=\"button\" role=\"tab\" aria-controls=\"course-pills-1\" aria-selected=\"true\">";
        // line 254
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("BECOMEANINSTRUCTOR_KEY", [], "messages");
        echo "</button>
                        </li>
                        <!-- Tab item -->
                        <li class=\"nav-item me-2 me-lg-4\" role=\"presentation\">
                            <button class=\"nav-link mb-2 mb-xl-0\" id=\"course-pills-tab-2\" data-bs-toggle=\"pill\" data-bs-target=\"#course-pills-2\" type=\"button\" role=\"tab\" aria-controls=\"course-pills-2\" aria-selected=\"false\">";
        // line 258
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("INSTRUCTORROLE_KEY", [], "messages");
        echo "</button>
                        </li>
                        <!-- Tab item -->
                        <li class=\"nav-item me-2 me-lg-4\" role=\"presentation\">
                            <button class=\"nav-link mb-2 mb-xl-0\" id=\"course-pills-tab-3\" data-bs-toggle=\"pill\" data-bs-target=\"#course-pills-3\" type=\"button\" role=\"tab\" aria-controls=\"course-pills-3\" aria-selected=\"false\">";
        // line 262
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("STARTWITHCOURSE_KEY", [], "messages");
        echo "</button>
                        </li>
                    </ul>
        ...
        echo "</h6>
                            ";
        // line 271
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("BECOMEANINSTRUCTORDETAIL_KEY", [], "messages");
        // line 272
        echo "                        </div>
        ...
        // line 282
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("INSTRUCTORROLEDESCRIPTIONLIST1_KEY", [], "messages");
        // line 283
        echo "                                </li>
                                <li class=\"list-group-item d-flex\">
                                    <i class=\"fas fa-check-circle text-success me-2 mt-1\"></i>";
        // line 285
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("INSTRUCTORROLEDESCRIPTIONLIST2_KEY", [], "messages");
        // line 286
        echo "                                </li>
                                <li class=\"list-group-item\">
                                    <i class=\"fas fa-check-circle text-success me-2\"></i>";
        // line 288
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("INSTRUCTORROLEDESCRIPTIONLIST3_KEY", [], "messages");
        // line 289
        echo "                                </li>
                            </ul>
                        </div>
        ...
        echo "</h6>
                            <p>
                                ";
        // line 297
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("STARTWITHCOURSEDESCRIPTION2_KEY", [], "messages");
        // line 298
        echo "                                <img src=\"";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/element/instructor-course.svg"), "html", null, true);
        echo "\" class=\"rounded float-start me-3 h-200px my-3\" alt=\"...\"> ";
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("STARTWITHCOURSEDESCRIPTION2_KEY", [], "messages");
        // line 299
        echo "                                <u>";
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("STARTWITHCOURSEDESCRIPTION3_KEY", [], "messages");
        echo "</u>  
                                ";
        // line 300
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("STARTWITHCOURSEDESCRIPTION4_KEY", [], "messages");
        // line 301
        echo "                            </p>
                        </div>
                    </div>
    ...
    <section class=\"pt-0\">
        ...
        // line 341
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("BECOMEANINSTRUCTORLOGINDESCRIPTION_KEY", [], "messages");
        echo "</p>
                            </div>
                            <!-- Button -->
        ...
        echo "\" class=\"btn btn-lg btn-white mb-0\">";
...
";
    ...
    {
        return "front/about/become_teacher.html.twig";
    }
    ...
    {
        return array (  581 => 345,  574 => 341,  570 => 340,  529 => 301,  527 => 300,  522 => 299,  517 => 298,  515 => 297,  510 => 295,  502 => 289,  500 => 288,  496 => 286,  494 => 285,  490 => 283,  488 => 282,  479 => 276,  473 => 272,  471 => 271,  467 => 270,  456 => 262,  449 => 258,  442 => 254,  435 => 250,  424 => 242,  415 => 236,  411 => 235,  404 => 231,  400 => 230,  393 => 226,  389 => 225,  383 => 222,  378 => 220,  348 => 193,  336 => 184,  324 => 175,  312 => 166,  275 => 132,  271 => 131,  267 => 130,  259 => 125,  255 => 124,  251 => 123,  243 => 118,  239 => 117,  235 => 116,  224 => 108,  220 => 107,  202 => 92,  194 => 87,  189 => 85,  185 => 84,  110 => 11,  100 => 10,  89 => 7,  79 => 6,  60 => 3,  37 => 1,);
    }
...
Page Banner START -->
    <section class=\"bg-light py-5 position-relative overflow-hidden\">
        ...
        <div class=\"container position-relative\">
            <div class=\"row g-4 align-items-center\">
                <div class=\"col-md-6\">
                    <!-- Title -->
                    <h1>{% trans %}APPLYASINSTRUCTOR_KEY{% endtrans %}</h1>
                    <p>{% trans %}APPLYASINSTRUCTORDESCRIPTION_KEY{% endtrans %}</p>
                    <!-- Button -->
                    <a href=\"#contactTitle\" class=\"btn btn-primary mb-0\">{% trans %}CONTACTUS_KEY{% endtrans %}</a>
                </div>

                <div class=\"col-md-6 text-center\">
                    <!-- Image -->
                    <img src=\"{{ asset('assets/images/element/04.svg') }}\" class=\"h-300px h-xl-400px\" alt=\"\">
                </div>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class=\"container\">
            ...
            <div class=\"row mb-4\">
                <div class=\"col-sm-10 col-xl-6 text-center mx-auto\">
                    <h2>{% trans %}STARTITLE_KEY{% endtrans %}</h2>
                    <p class=\"mb-0\">{% trans %}STARTITLEDESCRIPTION_KEY{% endtrans %}</p>
                </div>
            </div>
            ...
            <div class=\"row g-4 g-md-5\">
                ...
                <div class=\"col-md-4 text-center\">
                    ...
                    <h4 class=\"mt-3\">{% trans %}CREATEACCOUNT_KEY{% endtrans %}</h4>
                    <p class=\"text-truncate-2 mb-0\">{% trans %}STARCREATEACCOUNTDESCRIPTION_KEY{% endtrans %}</p>
                </div>

                <!-- Item -->
                <div class=\"col-md-4 text-center\">
                    <img src=\"{{ asset('assets/images/element/add-course.svg') }}\" class=\"h-200px\" alt=\"\">
                    <h4 class=\"mt-3\">{% trans %}STARADDYOURCOURSE_KEY{% endtrans %}</h4>
                    <p class=\"text-truncate-2 mb-0\">{% trans %}STARADDYOURCOURSEDESCRIPTION_KEY{% endtrans %}</p>
                </div>

                <!-- Item -->
                <div class=\"col-md-4 text-center\">
                    <img src=\"{{ asset('assets/images/element/earn-money.svg') }}\" class=\"h-200px\" alt=\"\">
                    <h4 class=\"mt-3\">{% trans %}STAREARINGMONEY_KEY{% endtrans %}</h4>
                    <p class=\"text-truncate-2 mb-0\">{% trans %}STAREARINGMONEYDESCRIPTITON_KEY{% endtrans %}</p>
                </div>
            </div> <!-- Row END -->
        </div>
    </section>
...
\t\t\t\t</svg>
                ...
                <div class=\"row g-4 position-relative align-items-center justify-content-center\">
                    ...
                    <div class=\"col-sm-6 col-lg-3 text-center\">
                        ...
                        <h6 class=\"mb-0 fw-bold\">{% trans %}TOTALCOURSES_KEY{% endtrans %}</h6>
                    </div>
                    ...
                    <div class=\"col-sm-6 col-lg-3 text-center\">
                        ...
                        <h6 class=\"mb-0 fw-bold\">{% trans %}TOTALINSTRUCTORS_KEY{% endtrans %}</h6>
                    </div>
                    ...
                    <div class=\"col-sm-6 col-lg-3 text-center\">
                        ...
                        <h6 class=\"mb-0 fw-bold\">{% trans %}LANGUAGES_KEY{% endtrans %}</h6>
                    </div>
                </div> <!-- Row END -->
            </div>
        </div>
        ...
        <div class=\"container\">
            <div class=\"row\">
                ...
                <div class=\"col-lg-5 position-relative mt-xl-0\" id=\"fill-instructor-form\">
                    ...
                    <div class=\"card card-body shadow p-4\">
                        <!-- Title -->
                        <h3>{% trans %}CONTACTUS_KEY{% endtrans %}</h3>
                        <!-- Form START -->
                        {{ form_start(contactForm, {'attr': {'class': 'row g-3 mt-2 position-relative z-index-9'}}) }}
                            <!-- Name -->
                            <div class=\"col-lg-6\">
                            ...
                            <div class=\"col-12\">
                                ...
                                {{ form_widget(contactForm.message, {'attr': {'rows': '3', 'spellcheck': false}}) }}
                            </div>
                            <!-- Button -->
                            <div class=\"col-12\">
                                <button type=\"submit\" class=\"btn btn-primary mb-0\">Submit form</button>
                ...
                <!-- Tabs START -->
                <div class=\"col-lg-7 z-index-9 mt-5 mt-xl-0\">
                    <h3>{% trans %}HOWTOBECOMEANINSTRUCTOR_KEY{% endtrans %}</h3>
                    <ul class=\"nav nav-pills nav-pill-soft my-4\" id=\"course-pills-tab\" role=\"tablist\">
                        <!-- Tab item -->
                        <li class=\"nav-item me-2 me-lg-4\" role=\"presentation\">
                            <button class=\"nav-link mb-2 mb-xl-0 active\" id=\"course-pills-tab-1\" data-bs-toggle=\"pill\" data-bs-target=\"#course-pills-1\" type=\"button\" role=\"tab\" aria-controls=\"course-pills-1\" aria-selected=\"true\">{% trans %}BECOMEANINSTRUCTOR_KEY{% endtrans %}</button>
                        </li>
                        <!-- Tab item -->
                        <li class=\"nav-item me-2 me-lg-4\" role=\"presentation\">
                            <button class=\"nav-link mb-2 mb-xl-0\" id=\"course-pills-tab-2\" data-bs-toggle=\"pill\" data-bs-target=\"#course-pills-2\" type=\"button\" role=\"tab\" aria-controls=\"course-pills-2\" aria-selected=\"false\">{% trans %}INSTRUCTORROLE_KEY{% endtrans %}</button>
                        </li>
                        <!-- Tab item -->
                        <li class=\"nav-item me-2 me-lg-4\" role=\"presentation\">
                            <button class=\"nav-link mb-2 mb-xl-0\" id=\"course-pills-tab-3\" data-bs-toggle=\"pill\" data-bs-target=\"#course-pills-3\" type=\"button\" role=\"tab\" aria-controls=\"course-pills-3\" aria-selected=\"false\">{% trans %}STARTWITHCOURSE_KEY{% endtrans %}</button>
                        </li>
                    </ul>
                    ...
                    <div class=\"tab-content\" id=\"pills-tabContent\">
                        <!-- Content -->
                        <div class=\"tab-pane fade show active\" id=\"course-pills-1\" role=\"tabpanel\" aria-labelledby=\"course-pills-tab-1\">
                            <h6>{% trans %}BECOMEANINSTRUCTOR_KEY{% endtrans %}</h6>
                            {% trans %}BECOMEANINSTRUCTORDETAIL_KEY{% endtrans %}
                        </div>

                        <!-- Content -->
                        <div class=\"tab-pane fade\" id=\"course-pills-2\" role=\"tabpanel\" aria-labelledby=\"course-pills-tab-2\">
                            <h6>{% trans %}INSTRUCTORROLE_KEY{% endtrans %}</h6>
                            <p></p>

                            <!-- Info -->
                            <ul class=\"list-group list-group-borderless mb-3\">
                                <li class=\"list-group-item\">
                                    <i class=\"fas fa-check-circle text-success me-2\"></i>{% trans %}INSTRUCTORROLEDESCRIPTIONLIST1_KEY{% endtrans %}
                                </li>
                                <li class=\"list-group-item d-flex\">
                                    <i class=\"fas fa-check-circle text-success me-2 mt-1\"></i>{% trans %}INSTRUCTORROLEDESCRIPTIONLIST2_KEY{% endtrans %}
                                </li>
                                <li class=\"list-group-item\">
                                    <i class=\"fas fa-check-circle text-success me-2\"></i>{% trans %}INSTRUCTORROLEDESCRIPTIONLIST3_KEY{% endtrans %}
                                </li>
                            </ul>
                        </div>
                        ...
                        <!-- Content -->
                        <div class=\"tab-pane fade\" id=\"course-pills-3\" role=\"tabpanel\" aria-labelledby=\"course-pills-tab-3\">
                            <h6>{% trans %}STARTWITHCOURSE_KEY{% endtrans %}</h6>
                            <p>
                                {% trans %}STARTWITHCOURSEDESCRIPTION2_KEY{% endtrans %}
                                <img src=\"{{ asset('assets/images/element/instructor-course.svg') }}\" class=\"rounded float-start me-3 h-200px my-3\" alt=\"...\"> {% trans %}STARTWITHCOURSEDESCRIPTION2_KEY{% endtrans %}
                                <u>{% trans %}STARTWITHCOURSEDESCRIPTION3_KEY{% endtrans %}</u>  
                                {% trans %}STARTWITHCOURSEDESCRIPTION4_KEY{% endtrans %}
                            </p>
                        </div>
                    </div>
                    <!-- Tab contents END -->
                ...
                <div class=\"row justify-content-center position-relative\">
                    ...
                    <div class=\"col-11 position-relative\">
                        <div class=\"row align-items-center\">
                            <!-- Title -->
                            <div class=\"col-lg-7\">
                                <h3 class=\"text-white\">{% trans %}BECOMEANINSTRUCTOR_KEY{% endtrans %}!</h3>
                                <p class=\"text-white mb-3 mb-lg-0\">{% trans %}BECOMEANINSTRUCTORLOGINDESCRIPTION_KEY{% endtrans %}</p>
                            </div>
                            <!-- Button -->
                            <div class=\"col-lg-5 text-lg-end\">
                                <a href=\"{{ url(\"app_front_register\", {type: 'trainer'}) }}\" class=\"btn btn-lg btn-white mb-0\">{% trans %}STARTTEACHINGTODAY_KEY{% endtrans %}</a>
                            </div>
                        </div>
                    </div>
                </div>
...
{% endblock %}", "front/about/become_teacher.html.twig", "V:\\PROJECT\\kulmapeck\\templates\\front\\about\\become_teacher.html.twig");
    }
}
