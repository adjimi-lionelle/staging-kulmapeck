...
class __TwigTemplate_1eb97a914b520571c847644d4fc577ae extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "admin/cours/edit.html.twig", 1);
    ...
    ";
        // line 13
        echo twig_include($this->env, $context, "includes/_delete_form.html.twig", ["path" => $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_cours_delete", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["cour"]) || array_key_exists("cour", $context) ? $context["cour"] : (function () { throw new RuntimeError('Variable "cour" does not exist.', 13, $this->source); })()), "id", [], "any", false, false, false, 13)]), "token" => $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . twig_get_attribute($this->env, $this->source, (isset($context["cour"]) || array_key_exists("cour", $context) ? $context["cour"] : (function () { throw new RuntimeError('Variable "cour" does not exist.', 13, $this->source); })()), "id", [], "any", false, false, false, 13))), "classes" => "btn-danger"]);
        echo "
";
    ...
    <div class=\"row\">
        <div class=\"col-md-9\">
            ";
        // line 20
        echo twig_include($this->env, $context, "cours/_form.html.twig", ["button_label" => "Enregistrer les modifications"]);
        echo "
        </div>
    </div>
...
";
    ...
    {
        return array (  163 => 20,  158 => 17,  148 => 16,  136 => 13,  129 => 10,  119 => 9,  100 => 7,  81 => 5,  62 => 3,  39 => 1,);
    }
...
{% block cardFooter %}
    <a class=\"btn btn-app\" href=\"{{ path('app_cours_index') }}\">
        <i class=\"fas fa-plus\"></i> Liste
    </a>
...
{% endblock %}
", "admin/cours/edit.html.twig", "V:\\PROJECT\\kulmapeck\\templates\\admin\\cours\\edit.html.twig");
    }
}
