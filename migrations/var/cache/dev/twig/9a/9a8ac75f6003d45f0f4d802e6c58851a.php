...
class __TwigTemplate_98fe36bc14cf44e0277029c8230705da extends Template
{
    private $source;
    private $macros = [];
...
\t";
        // line 11
        if ((array_key_exists("userType", $context) && ((isset($context["userType"]) || array_key_exists("userType", $context) ? $context["userType"] : (function () { throw new RuntimeError('Variable "userType" does not exist.', 11, $this->source); })()) === "student"))) {
            // line 12
            echo "\t
...
\t\t\t\t\t\t
\t\t\t\t\t\t<!-- Sub tittle -->
\t\t\t\t\t\t<h4 class=\"mb-3\">What you will get inside ?</h4>
\t\t\t\t\t\t<!-- List -->
...
\t\t\t\t\t\t\t
\t\t\t\t\t\t\t<div style=\"max-height: 450px; overflow: auto;\" class=\"p-4 custom-scrollbar\">
\t\t\t\t\t\t\t\t";
            // line 122
            echo twig_include($this->env, $context, "registration/_form.html.twig");
            echo "
\t\t\t\t\t\t\t</div>
...
array_key_exists("userType", $context) && ((isset($context["userType"]) || array_key_exists("userType", $context) ? $context["userType"] : (function () { throw new RuntimeError('Variable "userType" does not exist.', 131, $this->source); })()) === "trainer"))) {
            // line 132
            echo "\t\t
\t\t<section>
\t\t\t<div class=\"container\">
...
\t";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 158, $this->source); })()), "flashes", ["verify_email_error"], "method", false, false, false, 158));
...
";
    ...
    {
        return array (  265 => 161,  256 => 159,  252 => 158,  249 => 157,  237 => 148,  219 => 132,  217 => 131,  205 => 122,  93 => 12,  91 => 11,  88 => 10,  78 => 9,  59 => 3,  36 => 1,);
    }
...
\t{% if userType is defined and userType is same as 'student' %}
\t
\t\t<section class=\"pt-4 pt-sm-5\">
\t\t\t<div class=\"container\">
\t\t\t\t<div class=\"row g-4 g-md-5 justify-content-between\">
...
\t{% elseif userType is defined and userType is same as 'trainer' %}
\t\t
\t\t<section>
\t\t\t<div class=\"container\">
\t\t\t\t<div class=\"row g-5 justify-content-between\">
...
{% endblock %}
", "registration/register.html.twig", "V:\\PROJECT\\kulmapeck\\templates\\registration\\register.html.twig");
    }
}
