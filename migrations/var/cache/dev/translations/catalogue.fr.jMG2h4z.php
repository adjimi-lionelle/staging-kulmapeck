...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'NUMERO_REGISTRE_COMMERCE_KEY' => 'Numéro du registre du commerce',
    'LOCALISATION_KEY' => 'Localisation',
    'HOME_KEY' => 'Accueil',
    'COURSESFORMATION_KEY' => 'Cours & formations',
    'EXAM_KEY' => 'Examens',
    'FORUM_KEY' => 'Forum',
    'BECOME_PREMIUM_KEY' => 'Devenir Premium',
    'SEARCH_KEY' => 'Rechercher',
    'ENGLISH_KEY' => 'Anglais',
    'FRENCH_KEY' => 'Français',
    'DASHBOARD_KEY' => 'Tableau de bord',
    'EDIT_PROFILE_KEY' => 'Modifier le profil',
    'SIGNOUT_KEY' => 'Se déconnecter',
    'HELP_KEY' => 'Aide',
    'LIGHT_KEY' => 'Clair',
    'DARK_KEY' => 'Sombre',
    'AUTO_KEY' => 'Auto',
    'SIGNIN_KEY' => 'Se connecter',
    'COMPANY_KEY' => 'Compagnie',
    'COURSES_KEY' => 'Cours',
    'ABOUTUS_KEY' => 'Apropos de nous',
    'CONTACTUS_KEY' => 'Nous contacter',
    'COMMUNITY_KEY' => 'Communauté',
    'FAQ_KEY' => 'Faq',
    'SITEMAP_KEY' => 'Sitemap',
    'TEACHING_KEY' => 'Enseignement',
    'BECOMEATEACKER_KEY' => 'Devenir enseignant',
    'HOWTOGUIDE_KEY' => 'Comment guider',
    'TERMSANDCONDITIONS_KEY' => 'Termes &amp; Conditions',
    'CONTACT_KEY' => 'Contact',
    'TOLLFREE_KEY' => 'Parler librement',
    'EMAIL_KEY' => 'Email',
    'LANGUAGE_KEY' => 'Langue',
    'APPARANCE_KEY' => 'Apparance',
    'TERMSOFUSE_KEY' => 'Termes d\'utilisation',
    'PRIVACYPOLICY_KEY' => 'politique de confidentialité',
    'GOTOFORUM_KEY' => 'Consulter le forum',
    'BACKTOCOURSEDETAILS_KEY' => 'Revenir sur le cours',
    'ADDCOMMENT_KEY' => 'Ajouter un commentaire...',
    'CHOOSETYPEUSERACCOUNT_KEY' => 'Choisir le type de <span class="text-success">compte</span>',
    ...
    'TEACHER_KEY' => 'Enseigant & Formateur',
    'STUDENT_KEY' => 'Elève & Apprenant',
    'COURSESCATEGORY_KEY' => 'Catégories de cours',
    'VIEWALLCATEGORIES_KEY' => 'Toutes les catégories',
    'LASTCOURSES_KEY' => 'Derniers cours',
    'VIEWMORECOURSES_KEY' => 'Voir plus de cours',
    'DOWNLOADKULMAPECK_KEY' => 'Télécharger Kulmapeck',
    'MAINMESSAGE_KEY' => 'Apprentissage illimité à portée',
    'FINGERSTIPS_KEY' => 'de main',
    'MAINMESSAGEDESCRIPTION_KEY' => 'Marché d\'apprentissage et d\'enseignement en ligne avec plus de 5 000 cours et 10 millions d\'étudiants. Enseigné par des experts pour vous aider à acquérir de nouvelles compétences.',
    'LEARNEXPERT_KEY' => 'Apprenez avec des experts',
    'GETCERTIFICATE_KEY' => 'Obtenir un certificat',
    'GETMEMBERSHIP_KEY' => 'Get membership',
    'GETSTARTED_KEY' => 'Obtenir l\'adhésion',
    'CREATEACCOUNT_KEY' => 'Créer un compte',
    'CONGRATULATION_KEY' => 'Félicitations',
    'ADMISSIONCOMPLETE_KEY' => 'Votre admission terminée',
    'DAILYSTUDENT_KEY' => 'Nos nouveaux étudiants quotidiens',
    'OONLINECOURSES_KEY' => 'Online Courses',
    'EXPERTSTUTORS_KEY' => 'Cours en ligne',
    'ONLINESTUDENTS_KEY' => 'Étudiants en ligne',
    'CERTIFIEDCOURSES_KEY' => 'Cours certifiés',
    'MOSTPOPULAR_KEY' => 'Cours les plus populaires',
    'MOSTPOPULARDESCRIPTION_KEY' => 'Choisissez parmi des centaines de cours d\'organisations spécialisées',
    'LESSONS_KEY' => 'Leçons',
    'ALLCOURSES_KEY' => 'Tous les cours',
    'BECOMEINSTRUCTOR_KEY' => 'Devenir formateur!',
    ...
    'STARTTEACHINGTODAY_KEY' => 'Commencez à enseigner aujourd\'hui',
    'TRENDINGCOURSES_KEY' => 'Nos cours tendances',
    'TRENDINGCOURSESDESCRIPTION_KEY' => 'Découvrez la plupart des cours 🔥 sur le marché',
    'VERIFIEDMENTOR_KEY' => 'Mentors vérifiés',
    'FEEDBACK_KEY' => 'Quelques précieux retours de nos étudiants',
    ...
    'CREATEANACCOUNT_KEY' => 'Créer un compte',
    'WHATDOYOUWATTOLEARN_KEY' => 'Que voulez-vous apprendre?',
    'WHATDOYOUWATTOLEARNDESCRIPTION_KEY' => 'Développez vos compétences avec les cours et certifications en ligne les plus fiables',
    'SEARCHCOURSES_KEY' => 'Rechercher des cours',
    'CHOOSECATEGORY_KEY' => 'Choisissez une catégorie',
    'CHOOSECATEGORYDESCRIPTION_KEY' => 'Perceived end knowledge certainly day sweetness why cordially',
    'EARNCERTIFICATE_KEY' => 'Gagnez un certificat',
    'EARNCERTIFICATEDESCRIPTION_KEY' => 'Obtenez le bon programme de certificat professionnel pour vous.',
    'VIEWPROGRAMS_KEY' => 'Voir les programmes',
    'BESTRATEDCOURSES_KEY' => 'Cours les mieux notés',
    'BESTRATEDCOURSESDESCRIPTION_KEY' => 'Inscrivez-vous maintenant aux cours les plus populaires et les mieux notés.',
    'BESTRATEDCOURSESBTN_KEY' => 'Voir les cours',
    'SECTORS_KEY' => 'Filières',
    'SPECIALTIES_KEY' => 'Spécialités',
    'CLASSES_KEY' => 'Classes',
    'CATEGORIES_KEY' => 'Catégories',
    'ALL_KEY' => 'Tous',
    'ALLLEVEL_KEY' => 'Tous les niveaux',
    'EASY_KEY' => 'Facile',
    'INTERMEDIATE_KEY' => 'Intermédiaire',
    'DIFFICULT_KEY' => 'Difficile',
    'VERYDIFFICULT_KEY' => 'Très difficiles',
    'FREE_KEY' => 'Gratuit',
    'PAID_KEY' => 'Payant',
    'NORESULTS_KEY' => 'Auccun Résultat',
    'AREYOUREADYFORCONVERSATION_KEY' => 'Êtes-vous prêt pour une plus grande conversation ?',
    'SUBSCRIBE_KEY' => 'S\'abonner',
    'TYPEEMAILHERE_KEY' => 'Tapez votre e-mail ici',
    'DETAILS_KEY' => 'Détails',
    'VIEWMORE_KEY' => 'Voir plus',
    'EXAMS_KEY' => 'Examens',
    'SHOWFILTER_KEY' => 'Afficher le filtre',
    'EMPTY_KEY' => 'Liste Vide',
    'ADVANCEFILTER_KEY' => 'Filtre avancé',
    'CATEGORY_KEY' => 'Catégorie',
    'SKILLLEVEL_KEY' => 'Niveau de compétence',
    'FILTERRESULTS_KEY' => 'Filtrer les résultats',
    'SHOWANSWER_KEY' => 'Montrer la réponse',
    'BACKTOSUBJECT_KEY' => 'Retour au sujet',
    'APPLYASINSTRUCTOR_KEY' => 'Postuler en tant qu\'instructeur',
    ...
    'STARADDYOURCOURSE_KEY' => 'Ajoutez votre cours',
    ...
    'STAREARINGMONEY_KEY' => 'Commencez à gagner de l\'argent',
    ...
    'TOTALSTUDENTS_KEY' => 'Nombre total d\'étudiants',
    'TOTALINSTRUCTORS_KEY' => 'Nombre total d\'instructeurs',
    'TOTALCOURSES_KEY' => 'Total des cours',
    'LANGUAGES_KEY' => 'Langues',
    'HOWTOBECOMEANINSTRUCTOR_KEY' => 'Comment devenir Instructeur ?',
    'BECOMEANINSTRUCTOR_KEY' => 'Devenir instructeur',
    'INSTRUCTORROLE_KEY' => 'Rôle d\'instructeur',
    'STARTWITHCOURSE_KEY' => 'Commencez par le cours',
    ...
    'ABOUTUSPAGE_OURGOALTITLE_KEY' => 'Notre objectif',
    'ABOUTUSPAGE_OURGOAL_KEY' => 'Soyez ouvert aux nouvelles idées et approches. Développez vos compétences en résolution de problèmes.',
    'ABOUTUSPAGE_ABOUTKULMAPECKTILE_KEY' => 'À propos du portail Kulmapeck',
    ...
    'ABOUTUSPAGE_H4STUDENTS_KEY' => 'Plus de 35 000 étudiants heureux se sont joints à nous pour atteindre leurs objectifs',
    ...
    'ABOUTUSPAGE_INSTRUCTOR_KEY' => 'Instructeurs',
    'ABOUTUSPAGE_TEAM_KEY' => 'Rencontrez notre équipe',
    'ABOUTUSPAGE_JOINTEAM_KEY' => 'Rejoins notre équipe',
    'CONTACTPAGE_HELP_KEY' => 'Nous sommes là pour vous aider !',
    'CONTACTPAGE_WHATSAPP_KEY' => 'Assistance WhatsApp',
    'CONTACTPAGE_ORANGE_KEY' => 'Assistance Orange',
    'CONTACTPAGE_MTN_KEY' => 'Assistance MTN',
    'CONTACTPAGE_FOLLOWUS_KEY' => 'Suivez-nous sur',
    'CONTACTPAGE_LETSTALK_KEY' => 'Parlons',
    ...
    'CONTACTPAGE_SENDMESSAGEBTN_KEY' => 'Envoyer le message',
    'NOANSWERFOUND_KEY' => 'Aucune réponse trouvée',
    'REPLY_KEY' => 'Répondre',
    'RESOLVEDBY_KEY' => 'Résolu par ce post',
    'REMOVE_KEY' => 'Retirer',
    'RESOLVED_KEY' => 'Résolu',
    'UNRESOLVED_KEY' => 'Non résolu',
    'RESOLVEDCONFIRM_KEY' => 'Êtes-vous sûr de vouloir définir ces réponses comme la meilleure réponse ayant résolu votre problème ?',
    'QUESTIONSASKED_KEY' => 'Questions posées',
    'COMMENTS_KEY' => 'commentaires',
    'SHOWCOMMENT_KEY' => 'Afficher le commentaire',
    'NOTOPICSFOUND_KEY' => 'Aucun sujet trouvé ! Soyez le premier à poser un problème',
    'ASKQUESTION_KEY' => 'Pose ta question',
    'POST_KEY' => 'Poster',
    'OTHERSTOPICS_KEY' => 'Autres sujets',
    'TOPLISTED_KEY' => 'Cours les plus cotés',
    'STARTREADING_KEY' => 'Commencez à lire',
    'CONTINUE_KEY' => 'Continuer',
    'ALLCHAPTERS_KEY' => 'Description des chapitres',
    'CHAPTER_KEY' => 'Chapitre',
    'CHAPTERS_KEY' => 'Chapitres',
    'COURSEDESCRIPTION_KEY' => 'Matériel de cours',
    'YOURPROGRESS_KEY' => 'Votre progression',
    'COMPLETED_KEY' => 'Complété',
    'NOTCOMPLETED_KEY' => 'Pas achevé',
    'CONTINUE_READING_KEY' => 'Continuer la lecture',
    'ENROLLANDSTART_KEY' => 'S\'inscrire au cours et commencer',
    'ALLREADYENROLLED_KEY' => 'déjà inscrit',
    'BY_KEY' => 'Par',
    'PLAYLIST_KEY' => 'Playlist',
    'TRAINER_KEY' => 'Enseignant de Kulmapeck',
    'SHARE_KEY' => 'Partager',
    'COURSEOVERVIEW_KEY' => 'Description',
    'COURSE_REVIEWS_KEY' => 'Commentaires',
    'LESSON_KEY' => 'Leçon',
    'COURSE_CONTENT_KEY' => 'Le contenu des cours',
    'BACKTOCOURSE_KEY' => 'Retour aux cours',
    'GETINGSTARTED_KEY' => 'Commencer',
    'GENERAL_GUIDE_KEY' => 'Guide général',
    'ASSISTANCE_KEY' => 'Assistance',
    'CHOOSECATEGORYHELP_KEY' => 'Choisissez une catégorie pour trouver rapidement l\'aide dont vous avez besoin',
    'TOPICSLIST_KEY' => 'Liste des questions fréquentes',
    'NOTOPICFOUND_KEY' => 'Aucune question trouvée',
    'RELATEDTOPIC_KEY' => 'Rubrique connexe',
    'SUBMIT_KEY' => 'Soumettre',
    'HELLOHELP_KEY' => 'Bonjour, comment pouvons-nous vous aider ?',
    'CATEGORYDESCRIPTION_KEY' => 'Perceived end knowledge certainly day sweetness why cordially',
    'PERSONNE_NAME_KEY' => 'Nom de famille',
    'WELCOME_LOGIN_KEY' => 'Welcome to our largest community',
    'I_HAVE_FINISHED_KEY' => 'J\'ai fini cette leçon, je passe à la leçon suivante !',
    'COURSE_PLAYLIST_KEY' => 'Liste de lecture',
    'BACK_TO_COURSE_KEY' => 'Continuer la lecture',
    'NEXT_KEY' => 'Suivant',
    'PREV_KEY' => 'Précédent',
    'MANY_ANSWERS_POSSIBLE_KEY' => 'Plusieurs réponses sont possibles pour cette question',
  ),
));
