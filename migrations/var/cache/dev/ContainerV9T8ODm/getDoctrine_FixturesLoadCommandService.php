...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(($container->privates['App\\Repository\\UserRepository'] ?? $container->getUserRepositoryService()), ($container->privates['App\\Repository\\EnseignantRepository'] ?? $container->load('getEnseignantRepositoryService')), ($container->privates['App\\Repository\\EleveRepository'] ?? $container->load('getEleveRepositoryService')), ($container->privates['App\\Repository\\ClasseRepository'] ?? $container->load('getClasseRepositoryService')), ($container->privates['App\\Repository\\CoursRepository'] ?? $container->load('getCoursRepositoryService'))), 'groups' => []]]);
