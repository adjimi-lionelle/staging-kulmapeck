 ...
 */
class getVichUploader_Listener_Clean_FormationsPathService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.formations_path' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.formations_path'])) {
            return $container->privates['vich_uploader.listener.clean.formations_path'];
        }

        return $container->privates['vich_uploader.listener.clean.formations_path'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('formations_path', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? $container->getVichUploader_MetadataReaderService()), $a);
    }
}
