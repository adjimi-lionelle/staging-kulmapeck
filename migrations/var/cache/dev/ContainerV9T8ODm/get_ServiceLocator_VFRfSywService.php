 ...
 */
class get_ServiceLocator_VFRfSywService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private '.service_locator.VFRfSyw' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    public static function do($container, $lazyLoad = true)
    {
        return $container->privates['.service_locator.VFRfSyw'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'coursRepository' => ['privates', 'App\\Repository\\CoursRepository', 'getCoursRepositoryService', true],
            'course' => ['privates', '.errored..service_locator.VFRfSyw.App\\Entity\\Cours', NULL, 'Cannot autowire service ".service_locator.VFRfSyw": it needs an instance of "App\\Entity\\Cours" but this type has been excluded in "config/services.yaml".'],
